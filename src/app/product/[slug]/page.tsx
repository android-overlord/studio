        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-6">
            <a
              ...
              className="w-full inline-flex items-center justify-center py-3 px-6 bg-pink-500 text-white font-semibold rounded-full shadow-lg hover:bg-pink-600 transition-colors duration-300"
            >
